...
const CS2 = () => {
    ...
    return (
        <div className="container">
            <p><a href="/">Trang chủ</a> / <a href="/cs2">Trung tâm bồi dưỡng nghiệp vụ Hải Hà</a></p>
            <svg
            ...
            <h2>Trung tâm bồi dưỡng nghiệp vụ Hải Hà</h2>
  ...
  <span>
    {isExpanded ? (
      <>
        Trung tâm bồi dưỡng nghiệp vụ Hải Hà (Cơ sở Đồ Sơn) toạ lạc tại trung tâm khu du lịch Đồ Sơn. Cơ sở Đồ Sơn có tổng cộng .... phòng cùng với phòng ăn, phòng hội nghị sẵn sàng phục vụ quý khách. Ngoài ra, quý khách còn có thể thưởng thức view biển và tham quan có các địa điểm du lịch, vui chơi xung quanh Đồ Sơn. Với những lượt đánh giá tích cực trên các nền tảng, chúng tôi tự tin sẽ đem đến quý khách những dịch vụ tốt nhất.
      </>
    ) : (
      <>
        Trung tâm bồi dưỡng nghiệp vụ Hải Hà (Cơ sở Đồ Sơn) toạ lạc tại trung tâm khu du lịch Đồ Sơn.
      </>
    )}
  </span>
